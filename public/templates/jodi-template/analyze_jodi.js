...
// Find all classes containing 'jod-' or similar
const jodClasses = [...new Set([...html.matchAll(/(?:jod|jodi)-[a-zA-Z0-9_-]+/g)].map(m => m[0]))];
console.log('Jodi CSS classes found:', jodClasses);
...
console.log('All Keyframes in CSS:', [...new Set(keyframes)].filter(k => k.includes('jod') || k.includes('tw-')));
