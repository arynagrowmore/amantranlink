...
html = html.replace(/<h1 class="g-serif text-\[clamp\(3\.5rem,15vw,11rem\)\] font-semibold leading-\[0\.86\]" data-tw-reveal="true">Rudra<\/h1>/g,
  '<h1 class="g-serif text-[clamp(3.5rem,15vw,11rem)] font-semibold leading-[0.86]" data-tw-reveal="true" style="color:#FFFFFF !important; -webkit-text-fill-color:#FFFFFF !important; text-shadow:0 4px 20px rgba(0,0,0,0.5), 0 0 25px rgba(255,255,255,0.6);">Rudra</h1>'
);
...
html = html.replace(/<h1 class="g-serif text-right text-\[clamp\(3\.5rem,15vw,11rem\)\] font-semibold leading-\[0\.86\]" data-tw-reveal="true">Ishani<\/h1>/g,
  '<h1 class="g-serif text-right text-[clamp(3.5rem,15vw,11rem)] font-semibold leading-[0.86]" data-tw-reveal="true" style="color:#FFFFFF !important; -webkit-text-fill-color:#FFFFFF !important; text-shadow:0 4px 20px rgba(0,0,0,0.5), 0 0 25px rgba(255,255,255,0.6);">Ishani</h1>'
);
...
console.log('Successfully updated Rudra & Ishani to Pure White in index.html!');
