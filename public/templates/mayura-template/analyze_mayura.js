...
// Find all classes containing 'myr-' or similar
const myrClasses = [...new Set([...html.matchAll(/myr-[a-zA-Z0-9_-]+/g)].map(m => m[0]))];
console.log('Mayura CSS classes found:', myrClasses);
...
console.log('All Keyframes in CSS:', [...new Set(keyframes)].filter(k => k.includes('myr') || k.includes('feather') || k.includes('peacock') || k.includes('tw-')));
