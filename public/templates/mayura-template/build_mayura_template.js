...
body = body.replace(/<a[^>]*href="https:\/\/www\.jointhejashn\.com"[^>]*>www\.jointhejashn\.com<\/a>/gi, 
  '<p class="myr-foot-credit" style="font-size:0.7rem; letter-spacing:0.25em; text-transform:uppercase; opacity:0.75; margin-top:0.5rem;">With Blessings of Family & Friends · Forever & Always</p>'
);
...
<head>
  ...
  <title>The Mayura — Royal Peacock Wedding Invitation</title>
  <meta name="description" content="You are cordially invited to celebrate the royal wedding of Dhruv &amp; Shreya in The Mayura luxury peacock theme." />
  ...
  <!-- Tailwind CSS CDN with Full Mayura Theme Config -->
...
console.log('Successfully generated index.html for Mayura theme!');
