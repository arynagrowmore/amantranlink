...
// 1. Add Dress Code & Royal Etiquette Section before Venue
const dressCodeSection = `
  ...
  <section id="dress-code" class="jhr-dresscode py-16 px-4 relative overflow-hidden" style="background: radial-gradient(60% 80% at 50% 50%, #fffaf2 0%, var(--jhr-ivory, #fdf6ec) 100%);">
    <div class="jhr-head text-center max-w-2xl mx-auto mb-10" data-tw-reveal="true">
      ...
      <h2 class="text-3xl sm:text-4xl font-serif text-[#7a1f38] mt-2"><span class="l-en">Dress Code</span><span class="l-hi">पहनावा एवं रंग</span></h2>
...
if (!html.includes('id="dress-code"')) {
  // Insert before Venue section
  html = html.replace('<section id="venue"', `${dressCodeSection}\n<section id="venue"`);
}

// 2. Add Dress Code link to Navbar
if (!html.includes('href="#dress-code"')) {
  html = html.replace('<a href="#venue">', '<a href="#dress-code"><span class="l-en">Attire</span><span class="l-hi">पहनावा</span></a><a href="#venue">');
}

fs.writeFileSync('index.html', html);
console.log('Successfully added Dress Code & Live Stream sections to index.html!');
